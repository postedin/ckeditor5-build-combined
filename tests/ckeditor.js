...
describe('ClassicEditor build', () => {
  ...
  describe('create()', () => {
    beforeEach(() => ClassicEditor.create(editorElement)
      .then((newEditor) => {
        editor = newEditor;
      }));
  ...
  describe('config', () => {
    ...
    it('allows configuring toolbar items through config.toolbar', () => ClassicEditor
    ...
    // https://github.com/ckeditor/ckeditor5/issues/572
    it('allows configuring toolbar offset without overriding toolbar items', () => ClassicEditor
      .create(editorElement, {
        toolbar: {
